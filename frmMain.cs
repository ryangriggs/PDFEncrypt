...
namespace PDFEncrypt
{
	...
	public partial class frmMain : Form
	{
		...
		{
			return System.IO.Path.GetDirectoryName(file) + "\\" + System.IO.Path.GetFileNameWithoutExtension(file) + suffix + ".pdf";
		}

		private void btnInputBrowse_Click(object sender, EventArgs e)
		{
			var previouslySelectedInputFile = txtInputFile.Text;
			...
			// Generate output filename matching input with "-encrypted" if none is specified or if overwriting the one generated by default.
			if (txtOutputFile.Text == "" || txtOutputFile.Text == GetFilenameWithSuffix(previouslySelectedInputFile))
			{
				txtOutputFile.Text = GetFilenameWithSuffix(txtInputFile.Text);
			}
		}
